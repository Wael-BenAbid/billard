...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_LIFETIME': timedelta(minutes=int(os.environ.get('JWT_ACCESS_TOKEN_EXPIRE_MINUTES', 60))),
    'SLIDING_TOKEN_REFRESH_LIFETIME': timedelta(days=int(os.environ.get('JWT_REFRESH_TOKEN_EXPIRE_DAYS', 7))),
}

# CORS Configuration
CORS_ALLOWED_ORIGINS = [h.strip() for h in os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:5173,http://localhost:3000').split(',')]
